...
"""Fetch the pre-generated VexRiscv core for the DE25-Nano reference variant.
...
fetched core is git-ignored. Network is needed once (first build).

    python examples/de25_nano/vex/get_deps.py
