...
-- fpgacapZero ELA wrapper for Gowin GW1N / GW2A (VHDL).
--
-- Thin VHDL wrapper over the Verilog fcapz_ela_gowin module.
-- Instantiate this entity in VHDL designs; the underlying Verilog
-- source files must still be included in the project.
--
-- Usage:
--   u_ela : entity work.fcapz_ela_gowin
...
architecture rtl of fcapz_ela_gowin is
    ...
    component fcapz_ela_gowin_v is
        generic (
            SAMPLE_W     : positive;
            DEPTH        : positive;
    ...
    -- this VHDL entity.  In your synthesis tool, map fcapz_ela_gowin_v
    -- to the Verilog module fcapz_ela_gowin (most tools do this
    -- automatically when both sources are added to the project).

begin

    u_impl : fcapz_ela_gowin_v
        generic map (
            SAMPLE_W     => SAMPLE_W,
            DEPTH        => DEPTH,
