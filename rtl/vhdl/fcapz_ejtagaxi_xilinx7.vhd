...
entity fcapz_ejtagaxi_xilinx7 is
    generic (
        ADDR_W                 : positive := 32;
        DATA_W                 : positive := 32;
...
end entity fcapz_ejtagaxi_xilinx7;

architecture rtl of fcapz_ejtagaxi_xilinx7 is
    component fcapz_ejtagaxi_xilinx7_v is
        generic (
            ADDR_W                 : positive;
            DATA_W                 : positive;
            FIFO_DEPTH             : positive;
...
begin
    u_impl : fcapz_ejtagaxi_xilinx7_v
        generic map (
