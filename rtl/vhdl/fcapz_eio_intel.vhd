...
-- fpgacapZero EIO wrapper for Intel / Altera (VHDL).
--
-- Thin VHDL wrapper over the Verilog fcapz_eio_intel module.
-- Instantiate this entity in VHDL designs; the underlying Verilog
-- source files must still be included in the project.
--
-- Usage:
--   u_eio : entity work.fcapz_eio_intel
...
end entity fcapz_eio_intel;

architecture rtl of fcapz_eio_intel is

    component fcapz_eio_intel_v is
        generic (
            IN_W  : positive;
            OUT_W : positive;
            CHAIN : positive
