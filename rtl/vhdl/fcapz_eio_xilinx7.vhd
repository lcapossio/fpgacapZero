...
-- fpgacapZero EIO wrapper for Xilinx 7-series / UltraScale (VHDL).
--
-- Thin VHDL wrapper over the Verilog fcapz_eio_xilinx7 module.
-- Instantiate this entity in VHDL designs; the underlying Verilog
-- source files must still be included in the project.
--
-- Usage:
--   u_eio : entity work.fcapz_eio_xilinx7
...
architecture rtl of fcapz_eio_xilinx7 is
    ...
    component fcapz_eio_xilinx7_v is
        generic (
            IN_W  : positive;
            OUT_W : positive;
            CHAIN : positive
