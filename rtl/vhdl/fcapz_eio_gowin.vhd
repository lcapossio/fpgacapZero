...
-- fpgacapZero EIO wrapper for Gowin GW1N / GW2A (VHDL).
--
-- Thin VHDL wrapper over the Verilog fcapz_eio_gowin module.
-- Instantiate this entity in VHDL designs; the underlying Verilog
-- source files must still be included in the project.
--
-- Usage:
--   u_eio : entity work.fcapz_eio_gowin
...
architecture rtl of fcapz_eio_gowin is
    ...
    component fcapz_eio_gowin_v is
        generic (
            IN_W  : positive;
            OUT_W : positive;
            CHAIN : positive
