...
entity fcapz_ejtagaxi_xilinxus is
    generic (
        ADDR_W                 : positive := 32;
        DATA_W                 : positive := 32;
...
end entity fcapz_ejtagaxi_xilinxus;

architecture rtl of fcapz_ejtagaxi_xilinxus is
begin
    u_inner : entity work.fcapz_ejtagaxi_xilinx7
        generic map (
