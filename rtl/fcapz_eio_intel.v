...
// fpgacapZero EIO wrapper for Intel / Altera.
//
// Single-instantiation wrapper: bundles the EIO core, register interface,
// and one sld_virtual_jtag instance.
//
// Usage:
//   fcapz_eio_intel #(.IN_W(32), .OUT_W(32)) u_eio (
//       .probe_in(fabric_signals), .probe_out(driven_signals)
//   );

module fcapz_eio_intel #(
    parameter IN_W  = 32,
    parameter OUT_W = 32,
