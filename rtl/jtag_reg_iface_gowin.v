...
// JTAG to parallel register bus bridge (gowin).
//
// TAP signals (tck, tdi, tdo, capture, shift_in_en,
// shift_out_en, update, sel) are provided by an external
// GoWIN TAP - 'jtag_tap_gowin.v'.
//
